                ...
                <div id="loginbox" style="margin-top:150px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                    <div>
                        <div class="panel-heading">
                            <div class="panel-title" style="font-size: 5rem; color: black; margin-top: 1rem; margin-bottom: 1rem">Zaloguj się</div>
                        ...
                        <div class="panel-body" >
                            <#if message?has_content>
                                <div id="login-alert" class="alert alert-danger col-sm-12">
                                    <span class="kc-feedback-text">${kcSanitize(msg("alert"))?no_esc}</span>
                                </div>
                            </#if>
                            ...
                            <form id="kc-form-login" class="${properties.kcFormClass!}" onsubmit="login.disabled = true; return true;" action="${url.loginAction?keep_after('^[^#]*?://.*?[^/]*', 'r')}" method="post">
                                ...
                                <div id="kc-form-buttons" style="margin-top:10px" class="${properties.kcFormButtonsClass!}">
                                    <div class="${properties.kcFormButtonsWrapperClass!}">
                                        <input tabindex="4" class="button-green" style="font-size: 1.5em;" name="login" id="kc-login" type="submit" value="${msg("doLogIn")}"/>
